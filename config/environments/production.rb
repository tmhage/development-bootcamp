Rails.application.configure do
  ...
  config.action_controller.asset_host = "//s3.amazonaws.com/development-bootcamp-assets"
  ...
  config.action_mailer.default_url_options = { host: 'www.developmentbootcamp.nl' }
